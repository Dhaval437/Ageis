...
| **Current task** | P0-10 — SQLite bootstrap + migrations (next) |
| **Last session** | 2026-09-14 — P0-09 event-stream client + store |
| **Overall** | 11 / 103 tasks |
...
|---|---|---|---|---|---|
| P0 | Foundations & plumbing | 17 | 9 | 🟨 | App launches, core handshake works, one round-trip |
