...
| **Current task** | P0-17 — Engine-unavailable screen (next) |
| **Last session** | 2026-09-16 — P0-15 maximise/restore |
| **Overall** | 17 / 105 tasks |
...
|---|---|---|---|---|---|
| P0 | Foundations & plumbing | 18 | 15 | 🟨 | App launches, core handshake works, one round-trip |
