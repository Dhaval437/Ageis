...
| **Current task** | P0-15 — maximise/restore (next) |
| **Last session** | 2026-09-15 — P0-14 bundled fonts |
| **Overall** | 16 / 105 tasks |
...
|---|---|---|---|---|---|
| P0 | Foundations & plumbing | 18 | 14 | 🟨 | App launches, core handshake works, one round-trip |
